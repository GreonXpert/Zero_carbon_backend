...
const { saveFlowchart, getFlowchart,getFlowchartUser,updateFlowchartUser,updateFlowchartAdmin ,deleteFlowchartUser,deleteFlowchartAdmin, connectApi, disconnectApi, getFlowchartWithScopeSummary} = require('../controllers/flowchartController');
...
router.get('/get-with-scopes/:userId', getFlowchartWithScopeSummary); 
