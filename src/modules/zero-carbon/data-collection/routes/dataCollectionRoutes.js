...
const { auth, checkRole, checkPermission } = require("../../../../common/middleware/auth");
const { apiKeyMiddleware, apiKeyRateLimit } = require('../../api-key/middleware/apiKeyAuth');
const {
  saveAPIData,
  saveIoTData,
  saveManualData,
...
} = require('../../organization/controllers/dataCollectionController');

const {
  getDataCompletionStats,
} = require('../controllers/dataCompletionController');

const {
  attachDataEntryAccessContext,
} = require('../../organization/utils/Permissions/dataEntryPermission');

const uploadCsv = require('../../organization/utils/uploads/csv/uploadCsvMulter');
const { uploadOcr } = require('../../ocr/utils/uploads/ocr/upload');
const {
  saveOCRData,
  extractOCRPreview,
  confirmOCRSave,
  verifyOCRData
} = require('../../organization/controllers/ocrDataCollectionController');

const { getOCRFieldMappings } = require('../../organization/controllers/ocrFeedbackController');
