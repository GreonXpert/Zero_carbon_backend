...
const auth = require('../../../../common/middleware/auth'); // Your authentication middleware
...
const {
  ...
  getEmissionSummary
} = require('../emissionCalculationController');

const {
  recalculateHistoricalEmissions
} = require('../emissionIntegration');
...
const {
  ...
  saveManualData,
  getDataByUserNode
} = require('../../organization/controllers/dataEntryController');
