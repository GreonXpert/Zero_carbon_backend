...
const { autoUpdateFlowchartStatus } = require('../../reduction/utils/Workflow/workflow');
const {canManageFlowchart,canViewFlowchart, canAssignHeadToNode, canAccessModule, getNormalizedLevels} = require('../../../../common/utils/Permissions/permissions')
...
} = require('../../workflow/audit/flowchartAuditLog');
