...
const SurveyCycle = require('../models/SurveyCycle');
...
const {
  ...
  isSurveyLinkExpired,
  calculateLinkExpiry,
} = require('../../survey/services/surveyTokenService');
...
const {
  ...
  weeksForFrequency,
  buildEFLookup,
} = require('../../survey/services/surveyEmissionCalculator');

const { fetchScopeEFData } = require('../../survey/services/surveyEFHelper');
