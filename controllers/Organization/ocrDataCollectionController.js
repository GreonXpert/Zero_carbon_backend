...
const { buildOcrS3Key, uploadOcrToS3 } = require('../../utils/uploads/organisation/ocr/upload');
const { preprocessImage }              = require('../../utils/OCR/preprocessImage');
const { extractTextFromImage }         = require('../../utils/OCR/extractTextFromImage');
const { extractTextFromPDF }           = require('../../utils/OCR/extractTextFromPDF');
const { extractTextWithTextract, shouldUseTextractFallback } = require('../../utils/OCR/textractOCR');

// Legacy extractor (canonical field names — used by saveOCRData)
const { extractFields, mapScopeToCategory } = require('../../utils/OCR/fieldExtractor');

// New universal extractor + model matcher (used by extractOCRPreview)
const { extractAllFields }                   = require('../../utils/OCR/universalFieldExtractor');
const { matchFields, buildSuggestedDataValues, getCanonicalFieldOptions } = require('../../utils/OCR/modelMatcher');
const { createSession, getSession, deleteSession, getSessionExpiry } = require('../../utils/OCR/ocrSessionStore');
